...
- Native suite: 288 XCTest tests, 3 skips, zero failures, plus 10 Swift Testing meeting tests. Actual native-to-local-Atlas integration: one test passed against backend `1f0ec871` after final repairs.
